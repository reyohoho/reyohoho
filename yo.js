...
function yo(self) {
    ...
    options.player = ((options.title && /трейлер|trailer|teaser/i.test(options.title)) || t)
        ...
        : options.player
            ? options.player
            : 'hdrezka,collaps,hdvb,bazon,ustore,alloha,videocdn,iframe,pleer,kodik,kodik1,kodik2,kodik3,kodik4,kodik5,kodik6,';
    ...
    options.button = (options.button)
        ? options.button
        : 'hdrezka: {Q} {T}, collaps: {Q} {T}, videocdn: {Q} {T}, hdvb: {Q} {T}, bazon: {Q} {T}, ustore: {Q} {T}, alloha: {Q} {T}, iframe: {Q} {T}, kodik: {Q} {T}, kodik1: {Q} {T}, kodik2: {Q} {T}, kodik3: {Q} {T}, kodik4: {Q} {T}, kodik5: {Q} {T}, kodik6: {Q} {T},';
    if (options.button) {
